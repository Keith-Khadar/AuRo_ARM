...
''' Performs simply homography, mapping maze image to 8.5 inch x 11 inch sheet of paper.
    Automatically detects bounds using ArUco markers.
    Returns scaled image.
'''
def mazeHomography(image):  
